...
class PdfService {
  Future<File> generateProductPdf(ProductWithDetails productWithDetails) async {
    ...
    // Add PDF attachments by rendering them
    for (int i = 0; i < pdfAttachments.length; i++) {
      try {
        ...
        if (await pdfFile.exists()) {
          // Add a separator page before PDF
          pdf.addPage(
            pw.Page(
              pageFormat: PdfPageFormat.a4,
              margin: const pw.EdgeInsets.all(20),
                ...
                return pw.Center(
                  child: pw.Container(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        pw.Icon(
                          pw.IconData(0xe24d), // picture_as_pdf icon
                          size: 60,
                          color: PdfColors.red,
                        ),
                        pw.SizedBox(height: 16),
                        pw.Text(
                          'Attached PDF Document ${i + 1}',
                          style: pw.TextStyle(
                            fontSize: 18,
                            fontWeight: pw.FontWeight.bold,
                        ...
                        pw.Text(
                          'The following pages contain the attached PDF document',
                          style: const pw.TextStyle(
                            fontSize: 12,
                            color: PdfColors.grey700,
                          ),
          ...
          // Render PDF pages as images and add them
          try {
            final pdfBytes = await pdfFile.readAsBytes();
            
            // Convert PDF pages to images using Printing API
            ...
            // Add info page that PDF is attached but couldn't be rendered
            pdf.addPage(
              pw.Page(
                pageFormat: PdfPageFormat.a4,
                margin: const pw.EdgeInsets.all(20),
                    ...
                    child: pw.Container(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.SizedBox(height: 8),
                          pw.Text(
                            'A PDF document is attached to this product but could not be rendered in this export. Please view the original product to access the attached PDF.',
                            style: const pw.TextStyle(
                              fontSize: 12,
          ...
          // Add error page if PDF not found
          pdf.addPage(
            pw.Page(
              pageFormat: PdfPageFormat.a4,
              margin: const pw.EdgeInsets.all(20),
                  ...
                  child: pw.Container(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.SizedBox(height: 8),
                        pw.Text(
                          'The PDF attachment could not be loaded',
                          style: const pw.TextStyle(
                            fontSize: 12,
                            color: PdfColors.red700,
                          ),
